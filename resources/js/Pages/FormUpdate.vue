    ...
    <div>
        <form @submit.prevent="submit">
                <div class="grid grid-cols-2 mb-2">
                    <div>
                        ...
                        <div class="flex rounded-md shadow-sm">
                            <input type="text" v-model="form.username" class="flex-1 block w-full rounded-l-xl focus:outline-none text-lg px-3 py-1 border border-gray-300" placeholder="Jane">
                        </div>
                    </div>
                    <div>
                        <label class="block text-lg font-medium text-gray-700">
                        ...
                        <div class="flex rounded-md shadow-sm">
                            <input type="text" class="flex-1 block w-full rounded-r-xl focus:outline-none text-lg px-3 py-1 border border-gray-300" placeholder="Doe">
                        </div>
                    </div>
            </div>
            <label class="block text-lg font-medium text-gray-700">
            ...
            <div class="flex rounded-md shadow-sm mb-2">
                ...
                <input type="email" v-model="form.email" class="flex-1 block w-full rounded-r-xl focus:outline-none text-lg px-3 py-1 border border-gray-300" placeholder="example@example.com">
            </div>
            <label class="block text-lg font-medium text-gray-700">
                Password
            </label>
            <div class="flex rounded-md shadow-sm mb-2">
                ...
                <input type="password" v-model="form.password" class="flex-1 block w-full rounded-r-xl focus:outline-none text-lg px-3 py-1 border border-gray-300" placeholder="password">
            </div>
            <label class="block text-lg font-medium text-gray-700">
                Profile Picture
            </label>
