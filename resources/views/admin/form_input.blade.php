...
@section('content')
    ...
    <div class="border bg-gray-100 shadow-md text-gray-800 rounded-xl">
        <form class="p-5" action="{{route('dashboard.admin.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <label class="block text-lg font-medium text-gray-700">
                Username
            </label>
            <div class="flex rounded-md shadow-sm">
                <input type="text" name="username" class="flex-1 block w-full rounded-xl focus:outline-none text-lg px-3 py-1 border border-gray-300" placeholder="Jane">
            </div>
            <label class="block text-lg font-medium text-gray-700">
                Full Name
            </label>
            ...
            <div class="flex rounded-md shadow-sm mb-2">
                ...
                <input type="email" name="email" class="flex-1 block w-full rounded-r-xl focus:outline-none text-lg px-3 py-1 border border-gray-300" placeholder="example@example.com">
            </div>
            <label class="block text-lg font-medium text-gray-700">
                Password
            </label>
