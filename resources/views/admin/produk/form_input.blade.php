...
@section('content')
    ...
    <div class="border bg-gray-100 shadow-md text-gray-800 rounded-xl">
        <form class="p-5" action="{{route('dashboard.produk.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex rounded-md shadow-sm">
                <input type="number" name="qty" class="flex-1 block w-full rounded-xl focus:outline-none text-lg px-3 py-1 border border-gray-300">
            </div>
            <div class="mt-5">
